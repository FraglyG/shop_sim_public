...
loginForms.forEach(function (form) {
    form.addEventListener('submit', function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var type, username, password, response, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                    type = form.querySelector('.login_form_type').innerHTML;
                    username = form.querySelector('.login_form_username').value;
                    password = form.querySelector('.login_form_password').value;
                    return [4 /*yield*/, fetch('/auth/' + type, {
                            method: 'POST',
